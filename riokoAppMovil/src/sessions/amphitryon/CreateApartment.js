...
import CreateStyle from './ApartmentStyle';
...
const CreateApartment = ({navigation}) => {
  ...
  return <ScrollView style={CreateStyle.container}>
    ...
    <View style={CreateStyle.inputContainer}>
        ...
        <TextInput placeholder="Imagen Destacada" placeholderTextColor={"black"} style={CreateStyle.inputData} onChangeText={(e)=>setName(e)}></TextInput>
        <TextInput placeholder="Dirección" style={CreateStyle.inputData} placeholderTextColor={"black"}  onChangeText={(e)=>setCountry(e)}></TextInput>
        <TextInput placeholder="Ciudad" style={CreateStyle.inputData} placeholderTextColor={"black"}  onChangeText={(e)=>setCity(e)}></TextInput>
        <TextInput placeholder="Pais" style={CreateStyle.inputData} placeholderTextColor={"black"}  onChangeText={(e)=>setMail(e)}></TextInput>
